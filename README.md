...
- **RIESGO ACEPTABLE** (Green): Spread >500bp AND low volatility → Long MXN
- **PRECAUCIÓN** (Yellow): Mixed conditions → Maintain/Hedge
- **RIESGO ALTO** (Red): Spread <400bp OR vol spike → Short MXN (Buy USD)
...
**Built with care for Mexican market traders and analysts**
